...
def int_to_bin():
    subprocess.check_output([f'gcc -I../../lib/uart -I../../lib/stellaris/bearssl -I../../lib/BearSSL/inc int_to_bin.c ../../lib/stellaris/bearssl/beaverssl.c ../../lib/uart/uart_linux.c -o int_to_bin ../../lib/BearSSL/build/libbearssl.a'], shell=True)
